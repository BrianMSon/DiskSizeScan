...
const messages = {
  ko: {
    ...
    rescanTip: '현재 경로 재스캔',
    modified: '수정일',
    searchPlaceholder: '결과에서 검색 (예: node_modules, *.iso)',
    searchCount: '{n}개 일치',
    searchCapped: '상위 {shown}개만 표시',
  ...
  en: {
    ...
    rescanTip: 'Rescan current path',
    modified: 'Modified',
    searchPlaceholder: 'Search results (e.g. node_modules, *.iso)',
    searchCount: '{n} matches',
    searchCapped: 'showing top {shown}',
